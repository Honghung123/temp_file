...
//----------------------------------------------------------------------
// Connect Socket
//  Connect to socket by socketId, ip and port
//----------------------------------------------------------------------
int ConnectSocket(int socketId, char *ip, int port)
{
    ...
    {
        DEBUG(dbgNet, "InConnection failed \n");
        return -1;
    }
    return 0;
}
...
//----------------------------------------------------------------------
// Send to Socket
//  Send to socket by socketId, ip and port
//----------------------------------------------------------------------
int SendMessageToSocket(int socketId, char *message)
{
...
//----------------------------------------------------------------------
// Recive from Socket
//  Receive fromsocket by socketId, ip and port
//----------------------------------------------------------------------
int RecieveMessageFromSocket(int socketId, char *message)
{
    return read(socketId, message, 1024);
}
