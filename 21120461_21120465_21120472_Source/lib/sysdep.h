...
extern int ConnectSocket(int socketId, char *ip, int port);
extern int SendMessageToSocket(int socketId, char *message);
extern int RecieveMessageFromSocket(int socketId, char *message);
extern void CloseSocket(int sockID);
